        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="section">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="emergency_relationship" placeholder="e.g., Aunt, Grandmother">
                    </div>
                </div>
                <div class="form-group">
                    <label>Authorized Pickup (Name, Address, Phone)</label>
                    <input type="text" name="authorized_pickup">
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="medical_problems" placeholder="e.g., Asthma, Allergies">
                </div>
                <div class="form-group">
                    <label>Allergies</label>
                    <input type="text" name="allergies" placeholder="e.g., Peanuts, Dust">
                </div>
                <div class="form-group">
            ...
            <div class="section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="parent_signature" required>
                    </div>
                    <div class="form-group">
                        <label>Date Signed *</label>
                        <input type="date" name="date_signed" required value="<?php echo date('Y-m-d'); ?>">
                    </div>
                </div>
