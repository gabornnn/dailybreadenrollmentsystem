...
// Show students that are NOT archived (both Pending and Enrolled)
$stmt = $pdo->query("
    SELECT e.*, 
    ...
    ORDER BY 
        CASE WHEN e.enrollment_status = 'Pending' THEN 1 ELSE 2 END,
        e.enrollee_id DESC
");
...
<div class="container">
    ...
    <div class="info-note">
        <span> Pending applications need review. Click "View Details" to approve students.</span>
        <span> After approval, student will appear in "Enrolled Students" page.</span>
    </div>
        ...
        <table class="student-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge <?php echo $e['enrollment_status'] == 'Enrolled' ? 'badge-enrolled' : 'badge-pending-enrollment'; ?>">
